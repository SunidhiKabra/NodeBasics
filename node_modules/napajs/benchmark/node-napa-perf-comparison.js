...
function bench(zone) {
    return __awaiter(this, void 0, void 0, function () {
        var table, nodeTime, napaTime, _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    // Warm up.
                    test1();
                    return [4 /*yield*/, zone.execute('', 'test1', [])];
                case 1:
                    _b.sent();
                    table = [];
                    table.push(["node time", "napa time"]);
                    nodeTime = bench_utils_1.formatTimeDiff(test1());
                    _a = bench_utils_1.formatTimeDiff;
                    return [4 /*yield*/, zone.execute('', 'test1', [])];
                case 2:
                    napaTime = _a.apply(void 0, [(_b.sent()).value]);
